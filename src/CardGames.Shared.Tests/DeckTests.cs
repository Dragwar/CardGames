...
namespace CardGames.Shared.Tests
{
    public class DeckTests
    {
        ...
        public void Cards_NoShuffleShouldHaveSameLength_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: false);

            Assert.Equal(cards.Length, deck.Cards.Count);
        }

        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 25)]
        public void Cards_NoShuffleShouldEqual_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: false);
        ...
        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 25)]
        public void Cards_ShuffleShouldHaveSameLength_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: true);

            Assert.Equal(cards.Length, deck.Cards.Count);
        }

        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 25)]
        public void Cards_ShuffleShouldNotEqual_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: true);
        ...
        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 5)]
        public void Deal_NoShuffleShouldRemoveOneCard_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: false);
        ...
        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 5)]
        public void Deal_ShuffleShouldRemoveOneCard_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: true);
            var expected = deck.Deal();
            Assert.DoesNotContain(expected, deck.Cards);
        ...
        public void Deal_NoShuffleAtIndexShouldRemoveOneCard_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: false);
        ...
        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 3)]
        public void Deal_ShuffleAtIndexShouldRemoveOneCard_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: true);
            var expected = deck.Deal(3);
            Assert.DoesNotContain(expected, deck.Cards);
        ...
        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 25)]
        public void Deal_NoShuffleShouldEqual_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: false);
        ...
        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 5)]
        public void Deal_NoShuffleAtIndexShouldEqual_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: false);
        ...
        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 25)]
        public void Deal_ShuffleShouldNotEqual_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: true);
            var expected = cards[0];
        ...
        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 25)]
        public void Deal_ShuffleAtIndexShouldNotEqual_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: true);
            var index = cards.Length - 1;
            var expected = cards[index];
        ...
        public void DealAll_NoShuffleShouldRemoveAllCards_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: false);
        ...
        [Theory, MemberData(nameof(Get_Random_Cards_Theroy_Data), 25)]
        public void DealAll_ShuffleShouldRemoveAllCards_Theory(ICard[] cards)
        {
            var deck = new Deck(new ShuffleService<ICard>(), initialCards: cards, isShuffled: true);
            var dealtCards = deck.DealAll().ToArray();
            Assert.Empty(deck.Cards);
